...
import com.micromap.model.BuildingPosition;
...
public class BuildingPositionDao extends TBManager {
    ...
    public static final int BUILDING_FOR_MARK = 1;    //用于标注建筑的位置
    public static final int BUILDING_ROR_ROUTE = 0;   //用于标注建筑的最近的点
    ...
    public Position getBuidingPosition(int building_id, int type) {
        ...
        Cursor cursor = database.query(TABLE_NAME, null, "building_id = ? and buildingPos_type = ?",
                new String[]{"" + building_id, "" + type}, null, null, null);
