...
public class BuildingSearchResultActivity  extends Activity{
    ...
    private BuildingItemAdapter adapter;
    private String key[];
    private int value[];
    ...
    private List<Map<String, Object>> showData = null;
    private MicroMapApplication manager;
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        manager = (MicroMapApplication)getApplication();
		...
		adapter = new BuildingItemAdapter(context, showData, key, value);
