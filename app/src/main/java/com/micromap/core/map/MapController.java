...
public class MapController {
    ...
    public MapController(MapView mapView, int screenHeight, int screenWidth) {
    ...
    public void setZoom(int deepZoom){
    	if(deepZoom >= MicroMapApplication.MapConfig.MIN_DEEP_ZOOM
    			&& deepZoom <= MicroMapApplication.MapConfig.MAX_DEEP_ZOOM){
