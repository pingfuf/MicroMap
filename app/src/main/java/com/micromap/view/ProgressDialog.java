...
public class ProgressDialog extends AlertDialog {
    ...
    private LinearLayout initLayout(){
    	...
    	layout_h.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
    			LayoutParams.WRAP_CONTENT));

    	layout_message_h = new LinearLayout(mContext);
    	layout_message_h.setOrientation(LinearLayout.HORIZONTAL);
    	layout_message_h.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
    			LayoutParams.WRAP_CONTENT));
    	layout_message_h.setGravity(Gravity.CENTER);
    	
    	message_h = new TextView(mContext);
    	message_h.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    			LayoutParams.WRAP_CONTENT));
    	message_h.setMinHeight(30);
    	message_h.setWidth(60);
    	
    	number_ed = new TextView(mContext);
    	number_ed.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    			LayoutParams.WRAP_CONTENT));
    	...
    	number_cen.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    			LayoutParams.WRAP_CONTENT));
    	number_cen.setMinHeight(30);
    	
    	number_all = new TextView(mContext);
    	number_all.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    			LayoutParams.WRAP_CONTENT));
        ...
        progress_h.setProgressDrawable(mContext.getResources().getDrawable(
        		android.R.drawable.progress_horizontal));
        progress_h.setIndeterminateDrawable(mContext.getResources().getDrawable(
        		android.R.drawable.progress_indeterminate_horizontal));
        progress_h.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
        		LayoutParams.WRAP_CONTENT));
    	...
    	layout_s.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,
    			LayoutParams.WRAP_CONTENT));
        ...
        progress_number2.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
        		LayoutParams.WRAP_CONTENT));
